...
#SBATCH --time=23:52:00          # total run time limit (HH:MM:SS)
...
# python l2ws_setup_script.py robust_kalman cluster
# python aggregate_slurm_runs_script.py robust_kalman cluster
